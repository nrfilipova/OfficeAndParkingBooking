...
- Create Angular project with ng: `ng new officeandparkingbooking.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`officeandparkingbooking.client.esproj`).
